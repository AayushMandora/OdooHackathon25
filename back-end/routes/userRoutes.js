...
const { registerUser, loginUser, getUser, getUsers, getUserWithoutAuth, getUserById, updateUser, blockUser } = require("../controller/userController");

router.post("/register", registerUser);
router.post("/login", loginUser);
router.get("/me", authenticateToken(["user", "admin"]), getUser);
router.get("/", authenticateToken(["user", "admin"]), getUsers);
router.get("/without-auth", getUserWithoutAuth);
